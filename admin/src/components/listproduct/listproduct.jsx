...
const listproduct = () => {
  ...
  const fetchInfo=async()=>{
    await fetch('https://e-commerce-shopper-shi5.onrender.com/allproducts').then((res)=>res.json()).then((data)=>{
      setAllProducts(data)
    })
  }
  useEffect(()=>{
  ...
  const remove_product=async(id)=>{
    await fetch(`https://e-commerce-shopper-shi5.onrender.com/removeproduct`, {
      method: 'POST',
      headers: {
